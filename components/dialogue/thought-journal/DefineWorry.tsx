...
export default function DefineWorry({ initialWorry, onSubmit }: DefineWorryProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-medium text-blue-500 mb-2">What's worrying you right now and why?</h2>
      ...
      <div className="bg-gray-50 p-4 rounded-lg">
        <p className="text-gray-500 italic mb-2">
          e.g. There's a science test on Monday. I know for sure I'll get a zero and that people will laugh. Maybe I'll
          fail the class.
        </p>
      </div>
