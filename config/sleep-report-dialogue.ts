...
export const sleepReportDialogueConfig: QuestionnaireConfig = {
  ...
  steps: [
    ...
    },
    {
      ...
      choices: [
        { choiceId: 'not-at-all', text: 'Not at all noticeable at all' },
        { choiceId: 'barely', text: 'Barely' },
        { choiceId: 'somewhat', text: 'Somewhat' },
        { choiceId: 'much', text: 'Much' },
        { choiceId: 'very-much', text: 'Very Much Noticeable' },
      ],
    },
    {
      stepId: 'question-5',
      ...
      choices: [
        { choiceId: 'not-at-all', text: 'Not at all Worried' },
        { choiceId: 'a-little', text: 'A Little' },
        { choiceId: 'somewhat', text: 'Somewhat' },
        { choiceId: 'much', text: 'Much' },
        { choiceId: 'very-much', text: 'Very Much Worried' },
      ],
    },
  ],
};
